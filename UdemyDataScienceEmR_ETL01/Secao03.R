...
tab4<-read.xlsx("C:/Users/Isaias/Documents/ISAIAS TRABALHO/Cursos/R/Processo de ETL no R/dados/Meusdados.xlsx","tipo4",startRow = 2,endRow = 8)
...
tab2<-read.xlsx("C:/Users/Isaias/Documents/ISAIAS TRABALHO/Cursos/R/Processo de ETL no R/dados/Meusdados.xlsx","tipo2")
...
tab3<-read.xlsx("C:/Users/Isaias/Documents/ISAIAS TRABALHO/Cursos/R/Processo de ETL no R/dados/Meusdados.xlsx","tipo3")
...
tab3_arrumada<-tab3 %>% separate(taxa, into = c("Obitos Fetais", "Obitos"))

#Atenção ao tipo das variáveis... separate() mantem o tipo...a não ser que mande converter

tab3_arrumada<-tab3 %>% separate(taxa, into = c("Obitos Fetais", "Obitos"),convert=T)
...
tab3_separada %>% unite(juntooos, seculo, ano)

#para tirar o separador padrão "_"

tab3_separada %>% unite(JUNTO, seculo, ano,sep="")
...
tab3_sep<-read.xlsx("C:/Users/Isaias/Documents/ISAIAS TRABALHO/Cursos/R/Processo de ETL no R/dados/Meusdados.xlsx","tipo3_sep")

names(tab3_sep)[3]<-c("taxa")

tab3_nova<-tab3_sep %>% separate(taxa, into = c("Obitos Fetais", "Obitos"),sep="&")
